...
class OrderTest < ActiveSupport::TestCase
  ...
  context 'Find Orders' do
    ...
    should 'find orders and return expected fields' do
      ...
      expected_orders =
          [{order_id: @order1.id, start_time: @order1.slot_start_time, status: 'created', service_name: 'service1'},
           {order_id: @order2.id, start_time: @order2.slot_start_time, status: 'completed', service_name: 'service2'}]
